...
const PostCard = ({Title, ptag}) => {
  return (
    <div className="shadow-lg rounded-lg w-full bg-white p-2 ">
      <div className="flex  items-center flex-col ">
        <div className="flex items-center justify-between w-full my-2">
          <h3 className="text-[#717971] text-[16px] font-bold ">{Title}</h3>
          {/* <div>
            <img src={ThreeDotsIcon} alt="three dots" />
          </div> */}
        </div>
        <div className="flex items-center justify-between w-full">
          <p className="text-[#717971] text-[12px]">Ikeja Lagos</p>
          <p className="text-[#717971] text-[12px]">{ptag}</p>
        </div>
      </div>
      ...
      <div>
        <p className="text-[#717971] text-[12px] my-1">
